...
config_params = {
    ...
    # "feature_extraction_input_mode_filename" : os.path.realpath(os.path.join(THIS_FILE_PATH, "./models/trained_feature_extraction_model_spams.pkl")),
    "feature_extraction_input_mode_filename":None,
    "feature_extraction_output_model_filename" : os.path.realpath(os.path.join(THIS_FILE_PATH, "./models/trained_feature_extraction_model_spams.pkl")),
    ...
    # "classification_input_model_filename" : os.path.realpath(os.path.join(THIS_FILE_PATH, "./models/trained_classification_model_joachimssvm.pkl")),
    "classification_input_model_filename":None,
    "classification_output_model_filename" : os.path.realpath(os.path.join(THIS_FILE_PATH, "./models/trained_classification_model_joachimssvm.pkl")),
